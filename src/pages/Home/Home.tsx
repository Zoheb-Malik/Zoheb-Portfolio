...
export default function Home() {
  return (
    <PageTemplate header="Introduction 👋">
      <PageContent title="Brief Summary 📖" className="shift--text-left" removeMarginTop>
        <div>
          <p>I am a passionate and innovative full-stack software engineer with predominant expertise in front-end development and I possess a solid understanding of multiple programming languages.</p>
          ...
          <p>My career goal is to make a positive and lasting change in the industry, merging my expertise with my passion for travel and photography/videography- I aim to explore the world through my work, embracing new challenges and opportunities.</p>
          <p>Let's connect and collaborate on exciting projects that drive innovation and seek to create meaningful experiences!</p>
        </div>
      </PageContent>

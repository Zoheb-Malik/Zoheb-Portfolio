  ...
  return (
    <PageTemplate header='Introduction 👋'>
      <PageContent title='Brief Summary 📖' className='shift--text-left' removeMarginTop>
        <div>
        <p>
            I am a passionate and innovative full-stack software engineer with predominant expertise
            in front-end development and I possess a solid understanding of multiple programming
            languages.
          </p>
          <p>
            Skilled in JavaScript (ReactJS, NodeJS, TypeScript, AngularJS, VueJS), HTML (HTML3,
            HTML5), CSS (SASS/SCSS), Version Control via GitHub, Cloudflare, PHP, SQL (MySQL,
            NoSQL), and Artificial Intelligence (AI).
          </p>
          <p>
